...
function Banners() {
  return (
    <div className="flex items-center mt-10 justify-evenly pt-5 pb-12 ">
      <div className="banner flex flex-col justify-center items-end w-[300px] h-[160px] rounded-lg bg-[yellow] p-5">
